...
<div style="display: block; padding-top: 30px; margin-top: 100px; padding-left: 50px; height: fit-content; width: 95%; margin-right: auto; margin-left: auto; background-color: white; border-radius: 25px; padding-bottom: 30px; margin-bottom: 30px;" id="box">
    <fieldset style="border-radius: 10px; color: grey; display:block; height: fit-content; width: 90%; margin-left:50px; margin-right: auto;" id="meusdados">
        ...
        <h3 style="display: inline-block; position:relative; margin-left: 20px; top: -100px;">A FAT RACCOON
        ...
        <a style="display: inline-block; position: relative; top: -70px; left: -220px; color: black;" href="#">justafatraccoon@gmail.com</a>
        <a style="display: block; color:#00930f; margin-left: 25px; font-size: 16px; text-decoration: none; margin-top: -25px;" href="#">
        ...
        <div style="display: inline-block;  margin-top: -165px; margin-right: 70px; float: right; width: fit-content; height: fit-content; padding-left: 80px; text-align: center; border-left: 2px solid grey;">
